...
| **Local Folders** | Offline images & videos from personal folders | None | [Local Guide](docs/en_US/local.md) |
...
- Pixabay: free personal API token (see [Pixabay Guide](docs/en_US/pixabay.md)).
- Wallhaven: optional free personal API token (see [Wallhaven Guide](docs/en_US/wallhaven.md)).

---

## Usage

Explain how to access every user-facing entry:
...
For the complete documentation translated into Brazilian Portuguese, visit [docs/pt_BR/README.md](docs/pt_BR/README.md).
